...
Public Class fbayar
    ...
    Private Sub opendata()
        ...
        Const sql As String = "select top 100 a.nobukti,a.tanggal,b.nip,b.nama,a.jumlah,a.ket from ms_angsur a inner join ms_karyawan b on a.nip=b.nip where b.shiden=0 order by tanggal,nobukti desc"
    ...
    Private Sub cari()
        ...
        Dim sql As String = "select top 5000 a.nobukti,a.tanggal,b.nip,b.nama,a.jumlah,a.ket from ms_angsur a inner join ms_karyawan b on a.nip=b.nip where b.shiden=0"
    ...
    Private Sub hapus()
        ...
        Try
            ...
            Dim sql2 As String = String.Format("delete from ms_angsur where nobukti='{0}'", dv1(bs1.Position)("nobukti"))
            Using cmd2 As OleDbCommand = New OleDbCommand(sql2, cn, sqltrans)
                cmd2.ExecuteNonQuery()
            End Using

            Clsmy.InsertToLog(cn, "btangsur", 0, 0, 1, 0, dv1(Me.BindingContext(bs1).Position)("nobukti").ToString, dv1(Me.BindingContext(bs1).Position)("nip").ToString, sqltrans)
    ...
    Private Sub tsadd_Click(sender As System.Object, e As System.EventArgs) Handles tsadd.Click
        Using fkar2 As New fbayar2 With {.StartPosition = FormStartPosition.CenterParent, .dv = dv1, .addstat = True, .position = 0}
            fkar2.ShowDialog()
        End Using
    End Sub
    ...
    Private Sub tsedit_Click(sender As System.Object, e As System.EventArgs) Handles tsedit.Click
        ...
        Using fkar2 As New fbayar2 With {.StartPosition = FormStartPosition.CenterParent, .dv = dv1, .addstat = False, .position = bs1.Position}
            fkar2.ShowDialog()
        End Using
    End Sub
