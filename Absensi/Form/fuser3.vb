...
Public Class fuser3
    ...
    Private Sub addto()
        ...
        Dim sql As String = String.Format("select a.nip,a.nama,b.nama as golongan,a.depart from ms_karyawan a inner join ms_golongan b on a.kdgol=b.kode where a.aktif=1 and a.kdgol='{0}'", cbgol.EditValue)
        Dim sql2 As String = String.Format("select a.nip,a.nama,b.nama as golongan,a.depart from ms_karyawan a inner join ms_golongan b on a.kdgol=b.kode where a.aktif=1 and a.nip='{0}'", cbkary.EditValue)
        Dim sql3 As String = String.Format("select a.nip,a.nama,b.nama as golongan,a.depart from ms_karyawan a inner join ms_golongan b on a.kdgol=b.kode where a.aktif=1 and a.depart='{0}'", cbdepart.EditValue)
        ...
        Try
            ...
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                orow("depart") = dt.Rows(i)("depart").ToString
