...
Public Class rgaji_bulanan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Absensi.rgaji_bulanan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrgaji_bulanan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rgaji_bulanan = New rgaji_bulanan()
        rpt.Site = Me.Site
        Return rpt
    End Function
