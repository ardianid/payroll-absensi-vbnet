...
Public Class rgaji_mingguan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Absensi.rgaji_mingguan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrgaji_mingguan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rgaji_mingguan = New rgaji_mingguan()
        rpt.Site = Me.Site
        Return rpt
    End Function
